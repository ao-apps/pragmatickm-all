...
def upstreamProjects = [
  ...
  // Direct
  'contact/all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-contact-all</artifactId>
  'password/all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-password-all</artifactId>
  'procedure/all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-procedure-all</artifactId>
  'task/all', // <groupId>com.pragmatickm</groupId><artifactId>pragmatickm-task-all</artifactId>
